...
public class ComplexView extends AppCompatTextView {
    ...
    public ComplexView setStrokeColor(int cvStrokeColor) {
        this.cvStrokeColor = cvStrokeColor;
        return this;
    }

    public ComplexView setIconStart(@DrawableRes int resId) {
        cvIconStart = ContextCompat.getDrawable(getContext(), resId);
        return this;
    }

    public ComplexView setIconEnd(@DrawableRes int resId) {
        cvIconEnd = ContextCompat.getDrawable(getContext(), resId);
        return this;
    }

    public ComplexView setIconTop(@DrawableRes int resId) {
        cvIconTop = ContextCompat.getDrawable(getContext(), resId);
        return this;
    }

    public ComplexView setIconBottom(@DrawableRes int resId) {
        cvIconBottom = ContextCompat.getDrawable(getContext(), resId);
        return this;
    }

    public ComplexView setIconStart(Drawable drawable) {
        cvIconStart = drawable;
        return this;
    }

    public ComplexView setIconEnd(Drawable drawable) {
        cvIconEnd = drawable;
        return this;
    }

    public ComplexView setIconTop(Drawable drawable) {
        cvIconTop = drawable;
        return this;
    }

    public ComplexView setIconBottom(Drawable drawable) {
        cvIconBottom = drawable;
        return this;
    }

    public ComplexView setTintIconStart(@ColorRes int resId) {
        cvTintIconStart = ContextCompat.getColorStateList(getContext(), resId);
        return this;
    }

    public ComplexView setTintIconEnd(@ColorRes int resId) {
        cvTintIconStart = ContextCompat.getColorStateList(getContext(), resId);
        return this;
    }

    public ComplexView setTintIconTop(@ColorRes int resId) {
        cvTintIconTop = ContextCompat.getColorStateList(getContext(), resId);
        return this;
    }

    public ComplexView setTintIconBottom(@ColorRes int resId) {
        cvTintIconBottom = ContextCompat.getColorStateList(getContext(), resId);
        return this;
    }

    public ComplexView setNormalBgColor(@ColorInt int color) {
        this.cvNormalBgColor = color;

        return this;
    }

    public ComplexView setPressedBgColor(@ColorInt int color) {
        this.cvPressedBgColor = color;

        return this;
    }

    public ComplexView setDisableBgColor(@ColorInt int color) {
        this.cvDisableBgColor = color;
        return this;
    }
}
