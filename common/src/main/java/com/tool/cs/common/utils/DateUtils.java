...
public class DateUtils {
    ...
    public static String formatGMT0Hms(long time) {
        return format("HH:mm:ss", time, TimeZone.getTimeZone("GMT+0"));
    }
    ...
    public static String formatDefaultHms(long time) {
        return format("HH:mm:ss", time, TimeZone.getDefault());
    }

    public static String formatDefaultYmdHms(long time) {
        return format("yyyy-MM-dd HH:mm:ss", time, TimeZone.getDefault());
    }
